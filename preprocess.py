...
class preprocesses:
    ...
    def collect_data(self):
        output_dir = os.path.expanduser(self.output_datadir)#allow the user to expand the folder
        if not os.path.exists(output_dir):#it will check the folder wxistence
            os.makedirs(output_dir)#it will create the directory
